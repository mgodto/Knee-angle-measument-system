...
from measure_angles import measure_from_named_points, read_color
from train_keypoint_baseline import case_split_provenance, split_by_case
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "Examples:\n"
            "  python evaluate_keypoint_checkpoint.py --checkpoint models/current.pt "
            "--manifest images/annotation_processed_combined/processed_manifest_bone.csv --split all\n"
            "  python evaluate_keypoint_checkpoint.py --checkpoint outputs/run/best.pt "
